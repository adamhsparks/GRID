---
title: "GRID, GSOD(R) Interoplated Data"
...
[![Travis-CI Build Status](https://travis-ci.org/adamhsparks/GRID.svg?branch=master)](https://travis-ci.org/adamhsparks/GRID) 
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/adamhsparks/GRID?branch=master&svg=true)](https://ci.appveyor.com/project/adamhsparks/GRID) 
...
publication. The files hosted at https://github.com/adamhsparks/GRID are the
...
Once the download is complete, open the `GRID.Rproj` in RStudio to begin working
...
computer when you open `GRID.Rproj` in RStudio. Second is our Docker image that
