...
_GRID_ offers customised functionality to download GSOD data, `fetch_GSOD()`
...
_GRID_ offers customised functionality, `fetch_DEM()` to download a digital
...
```{r fetch_GSOD, eval=FALSE, message='hide', results='hide'}
...
```{r fetch_DEM, eval=FALSE, message='hide', results='hide'}
DEM <- fetch_DEM()
```
